...
def Read_image_Find_TAD(filepath,file_name,Save_Count_Max,move_range,model_path):
...
def TAD_find(path,image_name,Save_Count_Max,move_range,model_path):
    seq, X_test,max_test=Read_image_Find_TAD(path,image_name,Save_Count_Max,move_range,model_path)
